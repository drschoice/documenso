    ...
    settings:
      features.settings !== null
        ? {
            ...
            allowConfigureSigningCertificate:
              features.settings?.allowConfigureSigningCertificate ??
              DEFAULT_EMBEDDED_EDITOR_CONFIG.settings.allowConfigureSigningCertificate,
