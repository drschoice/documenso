...
export enum AppErrorCode {
  ...
  // Conditional visibility and copy-and-link, added by this fork.
  ...
  FIELD_LINK_CROSS_RECIPIENT = 'FIELD_LINK_CROSS_RECIPIENT',
  FIELD_LINK_TYPE_MISMATCH = 'FIELD_LINK_TYPE_MISMATCH',
}
