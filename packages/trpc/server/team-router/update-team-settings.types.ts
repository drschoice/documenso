...
import { ZSignatureFontFamilySchema, ZSignatureFontSizeSchema } from '@documenso/lib/constants/signature-fonts';
...
export const ZUpdateTeamSettingsRequestSchema = z.object({
  ...
  data: z.object({
    ...
    signatureFontFamily: ZSignatureFontFamilySchema.nullish(),
    signatureFontSize: ZSignatureFontSizeSchema.nullish(),
