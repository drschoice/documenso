...
export const AiFieldDetectionDialog = ({
  ...
  const sortedItems = useMemo(() => [...envelopeItems].sort((a, b) => a.order - b.order), [envelopeItems]);
                ...
                <fieldset className="space-y-1.5">
                  <div className="flex items-center justify-between">
                    ...
                    {showSelectAllToggle && (
                      ...
                      >
                        {excludedItemIds.size === 0 ? <Trans>Deselect all</Trans> : <Trans>Select all</Trans>}
                      </Button>
                    )}
                  </div>
                    ...
                    {sortedItems.map((item) => {
                      ...
                      return (
                        <li key={item.id} className="flex items-center gap-3 px-3 py-2">
                          ...
                          />
                          <Label htmlFor={checkboxId} className="flex-1 cursor-pointer font-normal text-sm">
                            {item.title}
                          </Label>
                        </li>
                      );
